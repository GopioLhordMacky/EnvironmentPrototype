...
byte validUID[4] = {0xDE, 0xAD, 0xBE, 0xEF};  // Replace with your actual tag UID
...
if (mfrc522.PICC_IsNewCardPresent() && mfrc522.PICC_ReadCardSerial()) 
  ...
  if (isValid) 
  {
    servoOpen = !servoOpen;  // Toggle
    servo.write(servoOpen ? 180 : 0);
    Serial.println(servoOpen ? "Servo: OPEN (180°)" : "Servo: CLOSE (0°)");
  } else 
  {
